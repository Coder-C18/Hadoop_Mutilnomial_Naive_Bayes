...
public class WordCount1Driver {
	public static void main(String[] args) {
		...
		FileInputFormat.setInputPaths(job_conf, new Path("C:\\hadoop-2.7.3\\test\\\\input\\Data_news.csv"));
		FileOutputFormat.setOutputPath(job_conf, new Path("C:\\hadoop-2.7.3\\test\\output10000"));
